# Zelda minish cap chinese bootleg analysis, part B
...
0x08f80388:
  ...
  if (r0 == 3) {
0x8f80a64:
    // run 0x8f80a90..0x8f80be4 from EWRAM
  }
  [...]
```
...
fcn.08f80b44:
  ...
  *0x8fc0000 = 0x90;
  ...
  while (*0x8fc0002 & 0x03 != 0);

  *0x8fc0000 = 0xff;
  *0x8fc0000 = 0x20;
  *0x8fc0000 = 0xd0;

  while (*0x8fc0000 != 0x80);
...
```C
0x0f80000:
  memcpy(0xe000000, 0x8fc0000, 0x8000);
```
